...
public class TimesQueTorce extends JFrame implements ActionListener {
	...
	JCheckBox cbFlamengo, cbCorinthians, cbPalmeiras, cbSaoPaulo;
	...
	public TimesQueTorce() {
		...
		// Checkboxes
		cbFlamengo = criarCheckBox("Flamengo");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == bSelecionados) {
			...
			if (cbFlamengo.isSelected()) timesSelecionados.append("Flamengo ");
